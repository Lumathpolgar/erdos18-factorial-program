...
- Overall state: `ENDPOINT_SUPPORT_CLOSED_OCCUPANCY_OPEN`
...
4. Freeze the exact target-dependent numerical-value law before requesting additive analytic estimates.
...
- Nova 4: `handoffs/TO_NOVA4.md`, marker-three regression and endpoint-support verification request.
...
Prove or disprove that every integer
...
The support endpoint is now closed. The remaining assertion is numerical downward-window occupancy.